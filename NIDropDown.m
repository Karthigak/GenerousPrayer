...
//      table.tableFooterView = [[UIView alloc] initWithFrame:CGRectMake(0, 0,table.frame.size.width, 1)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.list count]-1) {
        ...
        [lineLbl setFrame:CGRectMake(0, 39
                                     , tableView.frame.size.width,0.5)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self myDelegate];
    [self.delegate selectedString:c.textLabel.text];
