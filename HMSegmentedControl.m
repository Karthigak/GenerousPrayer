...
//    self.scrollView.backgroundColor=[UIColor orangeColor];
    ...
    shadow.frame = CGRectMake(0, -1,  self.scrollView.frame.size.width, 30);
    shadow.startPoint = CGPointMake(0.5, 1.0);
    shadow.endPoint = CGPointMake(0.5, 0.0);
    shadow.colors = [NSArray arrayWithObjects:(id)[[UIColor colorWithWhite:0.0 alpha:0.8f] CGColor], (id)[[UIColor clearColor] CGColor], nil];
