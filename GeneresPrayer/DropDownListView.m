...
//        if (isiPad) {
//            _kTableView = [[UITableView alloc] initWithFrame:CGRectMake(35,150,915,200)];
//        }else{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIColor *textColor=[CommonMethodClass pxColorWithHexValue:@"A3CC39"];
...
- (void)drawRect:(CGRect)rect {
    ...
    CGRect titleRect = CGRectMake(DROPDOWNVIEW_SCREENINSET + 70, DROPDOWNVIEW_SCREENINSET + 10 + 5,
    ...
    CGRect separatorRect = CGRectMake(DROPDOWNVIEW_SCREENINSET, DROPDOWNVIEW_SCREENINSET + DROPDOWNVIEW_HEADER_HEIGHT - 2,
                                      rect.size.width - 2 * DROPDOWNVIEW_SCREENINSET, 0);
...
//    [[UIColor colorWithWhite:1 alpha:1.] setFill];
    ...
    if (([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0)) {
        UIFont*font=[UIFont fontWithName:@"Myriad Pro" size:17];
      ...
      //  [_kTitleText drawInRect:titleRect withFont:[UIFont systemFontOfSize:17.]];
