...
@interface IndividualSignUpThree ()
{
...
@implementation IndividualSignUpThree
-(void)HUDAction
{
...
- (IBAction)RegisterComplete:(id)sender {
    if ([self.PasswordText.text isEqualToString:@""]) {
        ...
        [postData setObject:[defaults valueForKey:@"FirstName"] forKey:@"first_name"];
        [postData setObject:[defaults valueForKey:@"LastName"] forKey:@"last_name"];
        [postData setObject:[defaults valueForKey:@"Email"] forKey:@"email"];
        [postData setObject:[defaults valueForKey:@"Mobile"] forKey:@"mobile"];
        [postData setObject:[defaults valueForKey:@"DOB"] forKey:@"dob"];
        [postData setObject:@"0" forKey:@"user_type"];
...
- (IBAction)Dots:(id)sender {
    ...
    if (button.tag==0) {
        ...
        IndividualSignUpTwo *singUpOne=[self.storyboard instantiateViewControllerWithIdentifier:@"IndividualSignUpTwo"];
        [self.navigationController pushViewController:singUpOne animated:YES];
    }
...
-(void)getstureAnonmous{
    ...
    NSString *temp=[defaults valueForKey:@"TERMS"];
    if ([temp isEqualToString:@"isTermsChecked"]) {
        isTermsValidate=@"1";
        [self.buttonTerms setImage:[UIImage imageNamed:@"checkbox.png"] forState:UIControlStateNormal];
        [[NSUserDefaults standardUserDefaults]removeObjectForKey:@"TERMS"];
    }else{
        [[NSUserDefaults standardUserDefaults]setObject:@"isTermsChecked" forKey:@"TERMS"];
        isTermsValidate=@"0";
        [self.buttonTerms setImage:[UIImage imageNamed:@"checked.png"] forState:UIControlStateNormal];
