...
@implementation IndividualSignUpOne


#pragma viewcontroller Life Cycles
...
-(void)validate:(UIViewController *)goToViewController{
    if ([self.FirstNameText.text isEqualToString:@""]) {
        ...
        [defaults setObject:self.DOBLable.text forKey:@"DOB"];
