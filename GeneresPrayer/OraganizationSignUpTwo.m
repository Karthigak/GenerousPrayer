...
@interface OraganizationSignUpTwo ()
...
@implementation OraganizationSignUpTwo
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)validate:(UIViewController *)goToViewController{
    if ([self.EmailText.text isEqualToString:@""]) {
        ...
        [defaults setObject:self.EmailText.text forKey:@"EmailORG"];
        [defaults setObject:self.MobileText.text forKey:@"MobileORG"];
