...
//        NSArray *tab_H = [NSLayoutConstraint constraintsWithVisualFormat:@"V:[T(3)]" options:0 metrics:nil views:@{@"T": tab}];
//        NSArray *tab_V =[NSLayoutConstraint constraintsWithVisualFormat:@"H:[T(3)]" options:0 metrics:nil views:@{@"T": tab}];
//        
//        [tab addConstraints:tab_H];
//        [tab addConstraints:tab_V];
        //[tab setBackgroundColor:[UIColor orangeColor]];
        
//        CAGradientLayer *shadow = [CAGradientLayer layer];
//        shadow.frame = CGRectMake(0,0,contentView.frame.size.width, 4);
//        shadow.startPoint = CGPointMake(0.5, 1.0);
//        shadow.endPoint = CGPointMake(0.5, 0.0);
//        shadow.colors = [NSArray arrayWithObjects:(id)[[UIColor colorWithWhite:0.0 alpha:0.05f] CGColor], (id)[[UIColor clearColor] CGColor], nil];
//        [self.layer addSublayer:shadow];
//        
      [contentView addSubview:tab];
      [tab setTranslatesAutoresizingMaskIntoConstraints:NO];
      [VFL appendFormat:@"-%f-[T%d(%f)]", index ? 0.0f : 0, index, tab.frame.size.width];
      [views setObject:tab forKey:[NSString stringWithFormat:@"T%d", index]];
      
      [contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-63-[T]-2-|"
                                                                          options:0
                                                                          metrics:nil
                                                                            views:@{@"T": tab}]];
      [tab setTag:index];
    ...
    [contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-130-[S(2)]-0-|"
                                                                        options:0
                                                                        metrics:nil
                                                                          views:@{@"S": bottomLine}]];
